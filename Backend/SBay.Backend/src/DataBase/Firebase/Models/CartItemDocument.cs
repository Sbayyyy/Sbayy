...
internal sealed class CartItemDocument
{
    ...
    [FirestoreProperty] public decimal UnitPriceAmount { get; set; }
    ...
    public CartItem ToDomain()
    {
        ...
        DomainObjectFactory.SetProperty(listing, nameof(Listing.Id), ListingId);
        ...
        DomainObjectFactory.SetProperty(item, nameof(CartItem.ListingId), ListingId);
